...
import com.company.MariaSanchezU1Capstone.exception.NotFoundException;
import com.company.MariaSanchezU1Capstone.service.GameStoreInventoryService;
import com.company.MariaSanchezU1Capstone.viewmodel.TShirtViewModel;
...
public class TShirtController {
    ...
    public List<TShirtViewModel> getTShirtsBySize(@PathVariable("size") String size) {
        List<TShirtViewModel> tShirts = gameStoreInventoryService.findTShirtByColor(size);
        if (tShirts != null && tShirts.size() == 0)
